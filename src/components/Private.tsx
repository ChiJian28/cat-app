...
const Private: React.FC<PostProps> = ({ post }) => {
    ...
    <div key={post.id} className="md:w-[35%]">
      <div className="w-fit mx-auto mt-5 md:my-[50px]">
        ...
        <div className="flex items-center justify-between relative">
          ...
          {isWantDlt && (
            <div className="bg-slate-400 top-6 left-5 py-6 text-center rounded borded absolute">
        ...
        {isComment && (
          <div className="bg-green-500">
            {Object.keys(post.comments).length === 0 ? (
              ...
              <div className="bg-gray-300 flex flex-col space-y-2 h-[150px] overflow-y-scroll w-[300px]">
